...
import com.gamelibrary.repositories.OrderRepository;
...
public class OrderService {
    ...
    public OrderService(UserRepository userRepository, GameRepository gameRepository, OrderRepository orderRepository) {
